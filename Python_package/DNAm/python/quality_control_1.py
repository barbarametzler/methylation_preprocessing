...
def infer_sex(samples,threshold_chrX=0.37,threshold_chrY=0.39):
    ...
    plt.axvline(x=threshold_chrX, color='r', linestyle='dashed', linewidth=1)
    plt.axhline(y=threshold_chrY, color='b', linestyle='dashed', linewidth=1)
    plt.legend(loc='upper left')
    plt.title('Sex Infer plot')
